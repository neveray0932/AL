...
<body>
  ...
  <symbol id="geo-fill" viewBox="0 0 16 16">
	...
	<main>
		...
		<div class="flex-shrink-0 p-3 text-white bg-dark"
			style="width: 280px;">
			<a href="/"
				class="d-flex align-items-center pb-3 mb-3 link-dark text-decoration-none border-bottom text-white">
				<svg class="bi me-2" width="30" height="24">
					<use xlink:href="#bootstrap" /></svg> <span class="fs-5 fw-semibold">報價管理系統</span>
			</a>
			<ul class="list-unstyled ps-0">
				<li class="mb-1">
					<button
						...
						aria-expanded="false">管理</button>
					<div class="collapse" id="home-collapse">
						<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
							<li><a id="customer" class="link-dark rounded text-white">客戶管理</a></li>
							<li><a href="#" class="link-dark rounded text-white">報價管理</a></li>
							<li><a href="#" class="link-dark rounded text-white">產品管理</a></li>
						</ul>
					</div>
				</li>
				<li class="mb-1">
				...
				<li class="mb-1">
					<button
						...
						aria-expanded="false">成本</button>
					<div class="collapse" id="orders-collapse">
						<ul
							class="btn-toggle-nav list-unstyled fw-normal pb-1 small text-white">
		...
		<div class="container visually-hidden">
			...
			<div class="btn-toolbar" role="toolbar"
				aria-label="Toolbar with button groups" style="height: 50px;">
				<div class="btn-group me-2" role="group" aria-label="First group">
					<!-- 					<button id="new" type="button" class="btn btn-primary">新增</button> -->
				...
				<div class="btn-group" role="group" aria-label="Third group">
					<button type="button" class="btn btn-info">查詢</button>
				</div>
			</div>
			<div id="custbody"></div>
			<table id="custT" class="table table-striped"
					...
					<div class="modal-content">
						...
						<div class="modal-body ">
							<form method="post" id="UploadForm"
								action="/aluminum/customer.controller">
										...
										<div class="col-md-6 ms-auto">
											<div class="form-floating mb-3">
												...
												<input type="text" class="form-control" 
													placeholder="客戶姓名" name="customer" value=""> <label
													for="floatingInput">客戶:</label>
											</div>
										</div>
										<div class="col-md-6 ms-auto">
											<div class="form-floating mb-3">
												<input type="number" step="0.01"; class="form-control" 
													placeholder="係數" name="coefficient" value=""> <label
													for="floatingInput">係數:</label>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-6">
											<div class="form-floating mb-3">
												<input type="text" class="form-control" 
													placeholder="級數" name="series" value=""> <label
													for="floatingInput">級數:</label>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-floating mb-3">
												<input type="text" class="form-control" 
													placeholder="寶號" name="title" value=""> <label
													for="floatingInput">寶號:</label>
											</div>
										</div>
								...
								<tr>
									<div class="form-floating mb-3">
										<input type="address" class="form-control" 
											placeholder="地址" name="address" value=""> <label
											for="floatingInput">地址:</label>
									</div>
								...
								<tr>
									<div class="form-floating mb-3">
										<input type="phone" class="form-control" 
											placeholder="電話" name="phone" value=""> <label
											for="floatingInput">電話:</label>
									</div>
								...
								<tr>
									<div class="form-floating mb-3">
										<input type="phone" class="form-control" 
											placeholder="傳真" name="fax" value=""> <label
											for="floatingInput">傳真:</label>
									</div>
								...
								<tr>
									<div class="form-floating mb-3">
										<input type="text" class="form-control" 
											placeholder="聯絡人" name="contact" value=""> <label
											for="floatingInput">聯絡人:</label>
									</div>
								...
								<tr>
									<div class="form-floating mb-3">
										<input type="phone" class="form-control" 
											placeholder="行動電話" name="cellphone" value=""> <label
											for="floatingInput">行動電話:</label>
									</div>
								...
								<tr>
									<div class="form-floating mb-3">
										<input type="number" class="form-control" 
											placeholder="統一編號" name="guinum" value=""> <label
											for="floatingInput">統一編號:</label>
									</div>
								...
								<input class="btn btn-primary" type="submit"
									name="custcontroller" value="送出">
								<input class="btn btn-secondary" type="button"
									value="清除" onclick="clearForm()">
...
<script>
	$(document).ready(function() {
		...
		$('#customer').click(function() {
			...
			$.ajax({
				url : '/aluminum/public/api/customer1',
				method : 'get',
			...
			if ( $.fn.dataTable.isDataTable( '#custT' ) ) {
				table = $('#custT').DataTable();
			}
			else
				{
				var table = $('#custT').DataTable({
				...
				order : [ [ 0, 'desc' ] ],
				ajax : {
					url : '/aluminum/public/api/customer',
					dataSrc : ''
				},
				columns : [ {
					"data" : "customer"
